<?php
    ...
    **/ 
    ...
    $consExtensosFinalesAprobados="SELECT * FROM ponencia p,oral o,tipo_ponencia t,categoria c WHERE p.id_ponencia=o.id_ponencia and t.id_tipo_ponencia =p.id_tipo_ponencia and c.id_categoria=p.id_categoria and  o.id_usuario_evalua_final='$idEvaluador' AND p.id_congreso='$idCongreso';";
