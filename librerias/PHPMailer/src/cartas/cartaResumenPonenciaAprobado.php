...
require dirname(__DIR__) . '/librerias/PHPMailer/src/cartas/fpdf/fpdf.php';
...
//$pdf->Output('mipdf.pdf','d');    
    ...
    $pdf->Output('cbbcongress/librerias/PHPMailer/src/cartas/resumen/'.$idPonencia.'.pdf', 'F'); //esta linea guarda el pdf en el navegador
    //esta linea solo muestra el pdf en el navegador    
